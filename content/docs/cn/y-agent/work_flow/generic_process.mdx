...
自动选择下游角色的效果：TODO：效果图

自动选择下游角色的详细介绍](TODO：URL).
...
<include>./public/role_output_var.mdx</include>
  ...
  <Accordion title="如何输出变量到工作空间？">
    ...
    其他：[执行器节点说明](./wf_nodes/executor_node).   [批处理](/docs/y-agent/work_flow/wf_nodes/batch_node).
...
2.  编辑：在大模型节点中选择了一个提示词，可以直接点击 TODO：ICON 按钮，进入提示词编辑页面，编辑提示词内容。
