...
<Accordion title="流程日志查询" id="query_flow_logs">
工具名称：		
flow_logs	流程日志查询
...
2、大模型精筛文档：这个节点负责，通过分分批处理问题与文章的相关性让大模型精确筛选是否相关，相关的会把文章id存储到一个工作空间变量中，比如a变量。
